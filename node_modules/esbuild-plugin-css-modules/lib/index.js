    ...
    return ({
        ...
        setup: function (build) {
            ...
            build.onLoad({ filter: filter }, function (args) { return __awaiter(_this, void 0, void 0, function () {
                var fileContent, baseName, folderName, extName, preparedLocalIdentName, ast, classMap, baseFileName, tmpFilePath, contents;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            tmpFilePath = path_1.default.resolve(tmpDirPath, path_1.default.relative("/", path_1.default.dirname(args.path)), baseFileName + ".css");
