...
import { createContext, useRef as useRef4 } from "react";

// src/hooks/usePlayerState.ts
import { useCallback, useState } from "react";
var usePlayerState = ({ loop = false, mute = false, volume = 0.25 } = {}) => {
  const [trackInfo, setTrackInfo] = useState({ name: "Unknown" });
  ...
  const updateTrackInfo = useCallback((trackDataInfo) => {
...
var usePlayerUI = () => {
  const [isCollapse, setIsCollapse] = useState3(false);
  const [isClose, setIsClose] = useState3(true);
...
var usePlayerVFX = ({ ambientMode = false } = {}) => {
  const [useAmbientMode, setAmbientMode] = useState4(ambientMode);
...
var Button = ({ className, children, label, active = false, ...props }) => {
  ...
  return /* @__PURE__ */ jsx("button", { className: btnClassName, ...props, children: children ?? label });
};
...
var Overlay = ({ className, children }) => {
  ...
  return /* @__PURE__ */ jsx2("div", { className: `absolute left-0 top-0 p-2 size-full ${styles}`, children });
};
...
var OverlayVFX = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsx3(Overlay, { className: "pointer-events-none z-[1] p-0", children: useAmbientMode && /* @__PURE__ */ jsx3(Visualizer, { audioRef }) });
};
...
var Visualizer = ({ audioRef }) => {
  ...
  return /* @__PURE__ */ jsx4("canvas", { ref: canvasRef, width: window.innerWidth, height: 5, style: { width: "100%", height: "5px" } });
};
...
var Controls = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center ml-12 flex-grow gap-6 rounded-xl p-2 pointer-events-auto", children: [
    /* @__PURE__ */ jsx5(PlayControls, { ...PlayControlsProps }),
    /* @__PURE__ */ jsx5(Timeline, { ...TimelineProps }),
    /* @__PURE__ */ jsx5(PreferenseControls, { ...PreferenseControlsProps })
  ] });
};
...
var IcoRepeat = ({ color = "currentColor", size = 64, className = "" }) => {
  return /* @__PURE__ */ jsx8(
    "svg",
    {
      ...
      width: `${size}px`,
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx8("path", { d: "M8 20V21.9325C8 22.2086 7.77614 22.4325 7.5 22.4325C7.38303 22.4325 7.26977 22.3915 7.17991 22.3166L3.06093 18.8841C2.84879 18.7073 2.82013 18.392 2.99691 18.1799C3.09191 18.0659 3.23264 18 3.38103 18L18 18C19.1046 18 20 17.1046 20 16V8H22V16C22 18.2091 20.2091 20 18 20H8ZM16 4V2.0675C16 1.79136 16.2239 1.5675 16.5 1.5675C16.617 1.5675 16.7302 1.60851 16.8201 1.68339L20.9391 5.11587C21.1512 5.29266 21.1799 5.60794 21.0031 5.82008C20.9081 5.93407 20.7674 5.99998 20.619 5.99998L6 6C4.89543 6 4 6.89543 4 8V16H2V8C2 5.79086 3.79086 4 6 4H16Z" })
    }
  );
};
...
var IcoReport = ({ color = "currentColor", size = 64, className = "" }) => {
  return /* @__PURE__ */ jsx10(
    "svg",
    {
      ...
      width: `${size}px`,
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx10("path", { d: "M3 3H12.382C12.7607 3 13.107 3.214 13.2764 3.55279L14 5H20C20.5523 5 21 5.44772 21 6V17C21 17.5523 20.5523 18 20 18H13.618C13.2393 18 12.893 17.786 12.7236 17.4472L12 16H5V22H3V3Z" })
    }
  );
};
...
var IcoPause = ({ color = "currentColor", size = 64, className = "" }) => {
  return /* @__PURE__ */ jsx12(
    "svg",
    {
      ...
      width: `${size}px`,
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx12("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM9 9V15H11V9H9ZM13 9V15H15V9H13Z" })
    }
  );
};
...
var IcoVolume = ({ color = "currentColor", size = 64, className = "" }) => {
  return /* @__PURE__ */ jsxs2(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsx13("path", { d: "M232 416a23.88 23.88 0 0 1-14.2-4.68 8.27 8.27 0 0 1-.66-.51L125.76 336H56a24 24 0 0 1-24-24V200a24 24 0 0 1 24-24h69.75l91.37-74.81a8.27 8.27 0 0 1 .66-.51A24 24 0 0 1 256 120v272a24 24 0 0 1-24 24zm-106.18-80zm-.27-159.86zM320 336a16 16 0 0 1-14.29-23.19c9.49-18.87 14.3-38 14.3-56.81 0-19.38-4.66-37.94-14.25-56.73a16 16 0 0 1 28.5-14.54C346.19 208.12 352 231.44 352 256c0 23.86-6 47.81-17.7 71.19A16 16 0 0 1 320 336z" }),
        /* @__PURE__ */ jsx13("path", { d: "M368 384a16 16 0 0 1-13.86-24C373.05 327.09 384 299.51 384 256c0-44.17-10.93-71.56-29.82-103.94a16 16 0 0 1 27.64-16.12C402.92 172.11 416 204.81 416 256c0 50.43-13.06 83.29-34.13 120a16 16 0 0 1-13.87 8z" }),
        /* @__PURE__ */ jsx13("path", { d: "M416 432a16 16 0 0 1-13.39-24.74C429.85 365.47 448 323.76 448 256c0-66.5-18.18-108.62-45.49-151.39a16 16 0 1 1 27-17.22C459.81 134.89 480 181.74 480 256c0 64.75-14.66 113.63-50.6 168.74A16 16 0 0 1 416 432z" })
      ]
    }
  );
};
...
var IcoArrowDown = ({ color = "currentColor", size = 64, className = "" }) => {
  return /* @__PURE__ */ jsx15(
    "svg",
    {
      ...
      className,
      xmlns: "http://www.w3.org/2000/svg",
      children: /* @__PURE__ */ jsx15("path", { d: "M504 256c0 137-111 248-248 248S8 393 8 256 119 8 256 8s248 111 248 248zM212 140v116h-70.9c-10.7 0-16.1 13-8.5 20.5l114.9 114.3c4.7 4.7 12.2 4.7 16.9 0l114.9-114.3c7.6-7.6 2.2-20.5-8.5-20.5H300V140c0-6.6-5.4-12-12-12h-64c-6.6 0-12 5.4-12 12z" })
    }
  );
};
...
var PlayControls = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "flex items-center flex-shrink-0 gap-2", children: [
    /* @__PURE__ */ jsx18(Button, { onClick: handleBackwardSkip, children: /* @__PURE__ */ jsx18(IcoForwardBack, { size: iconSize }) }),
    /* @__PURE__ */ jsxs3(Button, { className: "group", onClick: togglePlay, children: [
      !isEnded && (isPlaying ? /* @__PURE__ */ jsx18(IcoPause, { size: iconSize }) : /* @__PURE__ */ jsx18(IcoPlay, { size: iconSize })),
      isEnded && /* @__PURE__ */ jsx18(IcoRepeat, { className: "group-hover:rotate-90 duration-300", size: iconSize })
    ] }),
    /* @__PURE__ */ jsx18(Button, { onClick: handleForwardSkip, children: /* @__PURE__ */ jsx18(IcoForwardNext, { size: iconSize }) }),
    /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-2 group", children: [
      /* @__PURE__ */ jsx18(Button, { onClick: toggleMute, children: isMuted || volume <= 0 ? /* @__PURE__ */ jsx18(IcoVolumeMute, { size: iconSize }) : /* @__PURE__ */ jsx18(IcoVolume, { size: iconSize }) }),
      /* @__PURE__ */ jsx18(VolumeSlider, { volume: currentPercentVolume, volumeChange: handleVolumeChange })
    ] })
  ] });
};
...
var PreferenseControls = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsx19(Fragment, { children: /* @__PURE__ */ jsxs4("div", { className: "flex items-center flex-shrink-0 gap-3", children: [
    /* @__PURE__ */ jsx19(Button, { onClick: toggleLoop, active: isLooped, children: /* @__PURE__ */ jsx19(IcoRepeat, { size: iconSize }) }),
    /* @__PURE__ */ jsx19(Button, { onClick: toggleAmbientMode, active: useAmbientMode, children: /* @__PURE__ */ jsx19(IcoEffect, { size: iconSize }) }),
    /* @__PURE__ */ jsx19(Button, { children: /* @__PURE__ */ jsx19(IcoReport, { size: iconSize }) })
  ] }) });
};
...
var ProgressBar = ({ progress }) => {
  return /* @__PURE__ */ jsxs5("div", { className: "absolute left-0 top-0 w-full h-full pointer-events-none bg-neutral-700 rounded-full", children: [
    /* @__PURE__ */ jsx20("div", { style: { width: `${progress}%` }, className: "h-full bg-orange-500 rounded-full" }),
    /* @__PURE__ */ jsx20("div", { style: { left: `${progress - 1}%` }, className: "absolute pointer-events-none top-0 bottom-0 my-auto cursor-pointer bg-orange-500 rounded-full size-3" })
  ] });
};
...
var Timeline = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "flex flex-col gap-1 flex-grow", children: [
    /* @__PURE__ */ jsx21("div", { onClick: handleSeek, className: "relative duration-300 w-full h-2 hover:h-3 bg-white/20 rounded-full group cursor-pointer", children: /* @__PURE__ */ jsx21(ProgressBar, { progress }) }),
    /* @__PURE__ */ jsxs6("div", { className: "flex items-center justify-between pointer-events-none", children: [
      /* @__PURE__ */ jsx21("p", { children: currentDuration }),
      /* @__PURE__ */ jsx21("p", { children: totalDuration })
    ] })
  ] });
};
...
var NextImage = (() => {
  try {
    return __require("next/image").default;
  } catch (error) {
    return null;
  }
})();
var CustomImage = ({ src, alt, ...props }) => {
  ...
  return /* @__PURE__ */ jsx22(ImageComponent, { src, alt, ...props });
};
...
var TrackDetails = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-6", children: [
    image ? /* @__PURE__ */ jsx23(CustomImage, { loading: "lazy", className: "object-cover rounded-full size-[56px]", width: 56, height: 56, src: image, alt: name }) : /* @__PURE__ */ jsx23("div", { className: "size-14 p-1 bg-additional rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx23(IcoMusic, { size: 24 }) }),
    /* @__PURE__ */ jsxs7("div", { children: [
      /* @__PURE__ */ jsx23("h2", { className: "text-lg text-white font-semibold", children: name }),
      description && /* @__PURE__ */ jsx23("p", { className: "text-neutral-400 text-sm", children: description })
    ] })
  ] });
};
...
var VolumeSlider = ({ volume, volumeChange }) => {
  const sliderRef = useRef3(null);
  const isDragging = useRef3(false);
  const handleVolumeChange = useCallback2((clientX) => {
  ...
  return /* @__PURE__ */ jsx24(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx24("div", { className: "absolute left-0 h-full bg-white rounded-full", style: { width: `${volume}%` } })
    }
  );
};
...
var Audio = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsx25(
    "audio",
    {
      ...
      preload,
      hidden: true,
      children: source && typeof source == "object" ? /* @__PURE__ */ jsx25("source", { src: source.src, type: `audio/${source.mimetype}` }) : /* @__PURE__ */ jsx25("source", { src: source || void 0 })
    }
  );
};
...
var VirbixPlayer = () => {
  ...
  return /* @__PURE__ */ jsxs8("div", { className, children: [
    /* @__PURE__ */ jsx26(Audio, { ...audioProps }),
    /* @__PURE__ */ jsx26(TrackDetails, { ...player.trackInfo }),
    /* @__PURE__ */ jsx26(OverlayVFX, { ...vfxProps }),
    /* @__PURE__ */ jsx26(Controls, { ...controlsProps }),
    /* @__PURE__ */ jsxs8("div", { className: `absolute gap-3 duration-300 flex items-center p-2 justify-center rounded-full right-6 ${ui.isCollapse ? "-translate-y-64" : "-translate-y-16"}`, children: [
      /* @__PURE__ */ jsx26(Button, { onClick: ui.toggleCollapse, active: ui.isCollapse, children: /* @__PURE__ */ jsx26(IcoArrowDown, { size: 24, className: `duration-300 ${ui.isCollapse && "rotate-180"}` }) }),
      /* @__PURE__ */ jsx26(Button, { onClick: playback.handleToggleClose, children: /* @__PURE__ */ jsx26(IcoClose, { size: 24 }) })
    ] })
  ] });
};
...
var MusicContext = createContext(null);
var MusicProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs9(MusicContext.Provider, { value: { audioRef, player, timeline, ui, playback, vfx }, children: [
    children,
    /* @__PURE__ */ jsx27(VirbixPlayer, {})
  ] });
};
export {
  MusicContext,
